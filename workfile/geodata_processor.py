...
processing.run('qgis:splitvectorlayer', {'INPUT':"outfile.csv", 'FIELD':"region", 'FILE_TYPE':1, 'OUTPUT':"C:/programming/MHGIS/workfile/categorised_master"})


    
# processing.run("qgis:splitvectorlayer", {parameter_dictionary}
